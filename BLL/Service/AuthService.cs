    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<string> ForgotPasswordAsync(string email)
        {
            try
            {
                ...
                // TODO: In production, you should send this token via email
                // For now, we'll return it directly (for testing purposes)
                // In production, you would:
                // 1. Send email with reset link containing the token
                // 2. Return success message without exposing the token
